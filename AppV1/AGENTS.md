...
Each agent module defines a single `AGENT_SYSTEM_PROMPT` (role instructions) and one main entry function used by `agents/workflow.py`. For diagrams, tool schemas, UI mapping, and the full module list, see **[`../docs/README.md`](../docs/README.md)**.
